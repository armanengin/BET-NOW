...
<head>
 ...
 <main>
    ...
    <?php while($id = mysqli_fetch_assoc($betslip_ids)){
        ...
        $sql_for_date = "SELECT date FROM betslip WHERE betslip_id = $id"; 
        $date = mysqli_query($db, $sql_for_date);
        $sql_for_comment = "SELECT comment FROM betslip WHERE betslip_id = $id"; 
        $comment = mysqli_query($db, $sql_for_comment);
    ?>
    ...
    -->
            <div class="col-5">
                <p style="float:right;">Shared at : <p><?php echo $date['date']?></p></p>
            </div>
            <div class="col-12" style="font-size:13px;">
                <p><p><?php echo $comment['comment']?></p></p>
            </div>
        </div>
                    ...
                    <div class="card"  >
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            ...
                            <tbody>
                                ...
                                <td><?php echo $bet_infos['mbn']?></td>
                                <td><?php echo mysqli_fetch_assoc($teams)?> - <?php echo mysqli_fetch_assoc($teams)?></td>
                                <td><?php echo $bet_infos['bet_time']?> / <?php echo $bet_infos['bet_date']?></td>
                                <td><?php echo $bet_infos['odd_type']?>: <?php echo $bet_infos['odd_value']?> </td>
                                <?php $row_num++; ?>
                                </tr>
                                <?php } ?>
                            </tbody>
