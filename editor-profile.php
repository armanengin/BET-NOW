<?php 
    ...
    $editor_sql_current_betslip = "SELECT betslip_id, betslip_date, name, no_of_bets, user_id, isShared, isSaved, isPlayed, isSuccess_betslip, totalOdd FROM betslip WHERE user_id = '$user_id' and isSuccess_betslip = 'NULL' ";
